...
export class Initial1546516145077 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `users` (`id` varchar(255) NOT NULL, `firstName` varchar(255) NOT NULL DEFAULT 'initialized', `lastName` varchar(255) NOT NULL DEFAULT 'initialized', `username` varchar(255) NOT NULL DEFAULT 'initialized', `password` varchar(255) NOT NULL DEFAULT 'initialized', `email` varchar(255) NOT NULL DEFAULT 'initialized', `roleId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `roles` (`id` varchar(255) NOT NULL, `role` varchar(255) NOT NULL DEFAULT 'User', PRIMARY KEY (`id`)) ENGINE=InnoDB");
